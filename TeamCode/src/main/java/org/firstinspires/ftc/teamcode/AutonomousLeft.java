...
@Autonomous(name="AutonomousLeft", group="Autonomous")
public class AutonomousLeft extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        ShootMotor.setPower(-0.625);
        leftDrive.setPower(0.725);
        rightDrive.setPower(0.725);
        sleep(1500); // Drive for 1.5 seconds

        // Action 2: Turn
        leftDrive.setPower(0.0);
        rightDrive.setPower(-0.175);
        sleep(1500); // Turn for 1 second
        ...
        for (int i = 0; i < 3; i++) {
            ...
            sleep(1500); // Time to push projectile
